...
<body>
    ...
    <form action="belajar_post.php" method="POST">
        ...
        <!-- tipe text -->
        <label for=""J>Jenis Kelamin</label><br>
        ...
        <input type="checkbox" name="mata_kuliah" value="Pemograman Web">
            <label for="">Pemograman Web</label><br><br>
        ...
        <select name="prodi">
            ...
            <option value="Bisnis Diigtal">Bisnis Digital</option>
        </select><br><br>
